...
class InstitutionsInstitution(models.Model):
    ...
    created_at = models.DateTimeField()
    institution_code = models.CharField(unique=True, max_length=20, blank=True, null=True)
    status = models.CharField(max_length=20)
    user = models.OneToOneField(AccountsUser, models.DO_NOTHING, blank=True, null=True)
    password_set = models.BooleanField()
...
class JobsJob(models.Model):
    ...
    status = models.CharField(max_length=20)
    created_at = models.DateTimeField()
    recruiter = models.ForeignKey('RecruitersRecruiter', models.DO_NOTHING)
...
class RecruitersRecruiter(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'recruiters_recruiter'


class RecruitersStudentselection(models.Model):
    status = models.CharField(max_length=20)
    created_at = models.DateTimeField()
    job = models.ForeignKey(JobsJob, models.DO_NOTHING)
    recruiter = models.ForeignKey(RecruitersRecruiter, models.DO_NOTHING)
    student = models.ForeignKey('StudentsStudent', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'recruiters_studentselection'
        unique_together = (('recruiter', 'student', 'job'),)


class RequestsCollegerequest(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'requests_collegerequest'
...
class StudentsStudent(models.Model):
    ...
    created_at = models.DateTimeField()
    institution = models.ForeignKey(InstitutionsInstitution, models.DO_NOTHING)
    user = models.OneToOneField(AccountsUser, models.DO_NOTHING, blank=True, null=True)
...
class StudentsStudentcorrectionrequest(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'students_studentcorrectionrequest'
